package br.solutionsjs.luastation.activities.registration
    ...
    private fun firebaseSignUp() {
        firebaseAuth.createUserWithEmailAndPassword(email, password)
            .addOnSuccessListener {
                ...
                startActivity(Intent(this@CompanyRegistrationActivity, HomeActivity::class.java))
                finish()
            }
            .addOnFailureListener { e ->
                Toast.makeText(
                    this@CompanyRegistrationActivity,
