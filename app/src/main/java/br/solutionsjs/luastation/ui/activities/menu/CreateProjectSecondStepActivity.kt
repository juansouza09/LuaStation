...
import br.solutionsjs.luastation.databinding.ActivityCreateProjectSecondStepBinding
import br.solutionsjs.luastation.data.models.Services
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class CreateProjectSecondStepActivity : AppCompatActivity() {

    private val binding by lazy { ActivityCreateProjectSecondStepBinding.inflate(layoutInflater) }
        ...
        if (serviceName.isEmpty()) {
            ...
            dbRef.child(serviceId).setValue(service)
                .addOnCompleteListener {
                    ...
                    startActivity(
                        Intent(
                            this@CreateProjectSecondStepActivity,
                            ProjectPaymentActivity::class.java
                        )
                    )
